...
{
    public class PdfViewEngine: ShaverViewEngine
    {

        public PdfViewEngine()
        {
            // This is where we tell MVC where to look for our files. This says
            // to look for a file at "Views/{Controller}/{Action}.cspdf"
            base.ViewLocationFormats = new string[] { "~/Views/{1}/{0}.cspdf", "~/Views/Shared/{0}.cspdf" };
        ...
        {
            return new PdfView(controllerContext, view);
        }
